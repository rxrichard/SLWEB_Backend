...
class CompraController {
  ...
  async Comprar({ request, response }) {
    ...
    //   const ProxPedidoID = null

    //   //salvo o pedido nas tabelas
    //   await Database.insert({
    //     GrpVen: verified.grpven,
    //    PedidoID: ProxPedidoID,
    //    STATUS: null,
    //    Filial: '0201',
    //    CpgId: '003',
